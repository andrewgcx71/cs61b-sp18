...
public class ArrayRingBuffer<T> extends AbstractBoundedQueue<T> {
    ...
    public ArrayRingBuffer(int capacity) {
        ...
        rb = (T[]) new Object[capacity];// create a generic type array, you first need to create an Object array, and then cast it to generic type array, actual data type will be depend on when define instance of collection.
    }
